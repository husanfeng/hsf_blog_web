 ...
 * http调用小程序云函数测试
 */
router.get('/api/getMiniProgromData', (req, res) => {
  // let url = 'https://api.weixin.qq.com/tcb/invokecloudfunction?access_token=28_zQ64DPRSp23L_flKYOKImxBongtx2uAGGaaJH6G6p4x95o0xMs1K-P-TTfsOqrKkVqGuPjQ2VUoxup9SiJr0jkOEKpjUKOXNUs-2XnOsD9TWZPkc0UIbDo_jsgvhxtXgF0tURFeiq5LFXB52PEIeAAAIXB&env=hsf-blog-product-jqt54&name=getArticleListData';
  // let data = {}
  // request(url, (error, response, body) => {
  //     parseString(body, (err, result) => {
  //         res.send({
  ...
  request({
    url: 'https://api.weixin.qq.com/tcb/invokecloudfunction?access_token=28_U5dQUy4nbNaL-povo9qORRcqhE_1wkgPpAc9d5Sw5SzFUo0AU2bEaFNR2mzJJVPdZ8VdL6ZeB8jTJ3HyrhFCtLQgak78Qv483xOblDcRHAnFRipUEhotitAsUKnp2gynq-kfgwhHKjN-v8JIKTMjAEAQZS&env=hsf-blog-product-jqt54&name=getArticleListData',
    //请求路径
    method: "POST",//请求方式，默认为get
    headers: {//设置请求头
      "content-type": "application/json",
    },
    body: JSON.stringify(body)//post参数字符串
